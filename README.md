...
3. Installed python packages:
    - boto3
    - click
    will be installed with the requirements.txt
    
---

## Installation
```bash #################### there wan't any "#" in the begining
###################################################################### insert my repo
git clone <your-repo>
cd <your-repo>
...
2. annaws s3 list --> List EC2 instances created by annaws-cli
# Help: annaws ec2 list --help
```bash
annaws ec2 list
```

3. annaws s3 Start/Stop --> strt/stop instances created by annaws-cli
...
----- S3 -----      # Help: annaws s3 --help

1. annaws s3 create --> creates private/public buckets
...
```
 ...
 ---- Route53 ----      # Help: annaws route53 --help
